 ...
 * 
 * @package KsfFA_ksf_FA_Forms
 * @version 2.4.3
 */

define('SS_ksf_FA_Forms', 123 << 8);
...
class hooks_ksf_FA_Forms extends hooks {
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_FormsVIEW'] = array(
            SS_ksf_FA_Forms | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_FormsMANAGE'] = array(
            SS_ksf_FA_Forms | 2, 
            _("Manage ")
        );
