<?php
/**
 * ksf_FA_Forms Module Hooks for FrontAccounting
 */

define('SS_ksf_FA_Forms', 100 << 8);

class hooks_ksf_FA_Forms extends hooks {
    var $module_name = 'ksf_FA_Forms';
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Forms] = _("");
        $security_areas['SA_ksf_FA_FormsVIEW'] = array(SS_ksf_FA_Forms | 1, _("View "));
        $security_areas['SA_ksf_FA_FormsMANAGE'] = array(SS_ksf_FA_Forms | 2, _("Manage "));
